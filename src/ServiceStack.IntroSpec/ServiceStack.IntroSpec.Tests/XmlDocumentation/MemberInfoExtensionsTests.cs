    ...
    public class MemberInfoExtensionsTests
    {
        ...
        public void GetMemberElementName_Type_NonGeneric()
        {
            nonGenericType.GetMemberElementName()
                .Should()
                .Be("T:ServiceStack.IntroSpec.Tests.XmlDocumentation.TestClass");
        }
        ...
        public void GetMemberElementName_Type_Embedded()
        {
            embeddedType.GetMemberElementName()
                .Should()
                .Be("T:ServiceStack.IntroSpec.Tests.XmlDocumentation.TestClass.EmbeddedClass");
        }
        ...
        public void GetMemberElementName_Type_Generic()
        {
            genericType.GetMemberElementName()
                .Should()
                .Be("T:ServiceStack.IntroSpec.Tests.XmlDocumentation.TestGenericClass`1");
        }
        ...
        public void GetMemberElementName_Type_MultiGeneric()
        {
            multiGenericType.GetMemberElementName()
                .Should()
                .Be("T:ServiceStack.IntroSpec.Tests.XmlDocumentation.TestMultiGenericClass`2");
        }
        ...
        public void GetMemberElementName_ParameterlessCtor_NonGeneric()
        {
            ...
            memberName.Should().Be("M:ServiceStack.IntroSpec.Tests.XmlDocumentation.TestClass.#ctor");
        }
        ...
        public void GetMemberElementName_ParameterlessCtor_Embedded()
        {
            ...
            var memberName = mi.GetMemberElementName();
            memberName.Should().Be("M:ServiceStack.IntroSpec.Tests.XmlDocumentation.TestClass.EmbeddedClass.#ctor");
        }
        ...
        public void GetMemberElementName_ParameterCtor_NonGeneric()
        {
            ...
            var memberName = mi.GetMemberElementName();
            memberName.Should().Be("M:ServiceStack.IntroSpec.Tests.XmlDocumentation.TestClass.#ctor(System.String)");
        }
        ...
        public void GetMemberElementName_ParameterlessCtor_Generic()
        {
            ...
            var memberName = mi.GetMemberElementName();
            memberName.Should().Be("M:ServiceStack.IntroSpec.Tests.XmlDocumentation.TestGenericClass`1.#ctor");
        }
        ...
        public void GetMemberElementName_ParameterCtor_Generic()
        {
            ...
            var memberName = mi.GetMemberElementName();
            memberName.Should().Be("M:ServiceStack.IntroSpec.Tests.XmlDocumentation.TestGenericClass`1.#ctor(`0)");
        }
        ...
        public void GetMemberElementName_ParameterlessCtor_MultiGeneric()
        {
            ...
            var memberName = mi.GetMemberElementName();
            memberName.Should().Be("M:ServiceStack.IntroSpec.Tests.XmlDocumentation.TestMultiGenericClass`2.#ctor");
        }
        ...
        public void GetMemberElementName_FirstGenericParameterCtor_MultiGeneric()
        {
            ...
            var memberName = mi.GetMemberElementName();
            memberName.Should().Be("M:ServiceStack.IntroSpec.Tests.XmlDocumentation.TestMultiGenericClass`2.#ctor(`0)");
        }
        ...
        public void GetMemberElementName_SecondGenericParameterCtor_MultiGeneric()
        {
            ...
            MemberInfo mi = multiGenericType.GetConstructor(types);
            var memberName = mi.GetMemberElementName();
            memberName.Should().Be("M:ServiceStack.IntroSpec.Tests.XmlDocumentation.TestMultiGenericClass`2.#ctor(`1)");
        }
        ...
        public void GetMemberElementName_BothGenericParameterCtor_MultiGeneric()
        {
            ...
            MemberInfo mi = multiGenericType.GetConstructor(types);
            var memberName = mi.GetMemberElementName();
            memberName.Should().Be("M:ServiceStack.IntroSpec.Tests.XmlDocumentation.TestMultiGenericClass`2.#ctor(`0,`1)");
        }
        ...
        public void GetMemberElementName_Field_NonGeneric()
        {
            ...
            var memberName = mi.GetMemberElementName();
            memberName.Should().Be("F:ServiceStack.IntroSpec.Tests.XmlDocumentation.TestClass.MyField");
        }
        ...
        public void GetMemberElementName_Field_Embedded()
        {
            ...
            var memberName = mi.GetMemberElementName();
            memberName.Should().Be("F:ServiceStack.IntroSpec.Tests.XmlDocumentation.TestClass.EmbeddedClass.MyField");
        }
        ...
        public void GetMemberElementName_Field_Generic()
        {
            ...
            var memberName = mi.GetMemberElementName();
            memberName.Should().Be("F:ServiceStack.IntroSpec.Tests.XmlDocumentation.TestGenericClass`1.MyField");
        }
        ...
        public void GetMemberElementName_Field_MultiGeneric()
        {
            ...
            var memberName = mi.GetMemberElementName();
            memberName.Should().Be("F:ServiceStack.IntroSpec.Tests.XmlDocumentation.TestMultiGenericClass`2.MyField");
        }
        ...
        public void GetMemberElementName_Property_NonGeneric()
        {
            ...
            var memberName = mi.GetMemberElementName();
            memberName.Should().Be("P:ServiceStack.IntroSpec.Tests.XmlDocumentation.TestClass.MyProperty");
        }
        ...
        public void GetMemberElementName_Property_Embedded()
        {
            ...
            var memberName = mi.GetMemberElementName();
            memberName.Should().Be("P:ServiceStack.IntroSpec.Tests.XmlDocumentation.TestClass.EmbeddedClass.MyProperty");
        }
        ...
        public void GetMemberElementName_Property_Generic()
        {
            ...
            var memberName = mi.GetMemberElementName();
            memberName.Should().Be("P:ServiceStack.IntroSpec.Tests.XmlDocumentation.TestGenericClass`1.MyProperty");
        }
        ...
        public void GetMemberElementName_Property_MultiGeneric()
        {
            ...
            var memberName = mi.GetMemberElementName();
            memberName.Should().Be("P:ServiceStack.IntroSpec.Tests.XmlDocumentation.TestMultiGenericClass`2.MyProperty");
        }
        ...
        public void GetMemberElementName_Event_NonGeneric()
        {
            ...
            var memberName = mi.GetMemberElementName();
            memberName.Should().Be("E:ServiceStack.IntroSpec.Tests.XmlDocumentation.TestClass.MyEvent");
        }
        ...
        public void GetMemberElementName_Event_Embedded()
        {
            ...
            var memberName = mi.GetMemberElementName();
            memberName.Should().Be("E:ServiceStack.IntroSpec.Tests.XmlDocumentation.TestClass.EmbeddedClass.MyEvent");
        }
        ...
        public void GetMemberElementName_Event_Generic()
        {
            ...
            var memberName = mi.GetMemberElementName();
            memberName.Should().Be("E:ServiceStack.IntroSpec.Tests.XmlDocumentation.TestGenericClass`1.MyEvent");
        }
        ...
        public void GetMemberElementName_Event_MultiGeneric()
        {
            ...
            var memberName = mi.GetMemberElementName();
            memberName.Should().Be("E:ServiceStack.IntroSpec.Tests.XmlDocumentation.TestMultiGenericClass`2.MyEvent");
        }
        ...
        public void GetMemberElementName_ParameterlessMethod_NonGeneric()
        {
            ...
            var memberName = mi.GetMemberElementName();
            memberName.Should().Be("M:ServiceStack.IntroSpec.Tests.XmlDocumentation.TestClass.ParameterlessAndVoidReturn");
        }
        ...
        public void GetMemberElementName_ParameterMethod_NonGeneric()
        {
            ...
            var memberName = mi.GetMemberElementName();
            memberName.Should().Be("M:ServiceStack.IntroSpec.Tests.XmlDocumentation.TestClass.ParametersWithReturn(System.String,System.Int32)");
        }
        ...
        public void GetMemberElementName_ParameterlessMethod_Embedded()
        {
            ...
            var memberName = mi.GetMemberElementName();
            memberName.Should().Be("M:ServiceStack.IntroSpec.Tests.XmlDocumentation.TestClass.EmbeddedClass.Parameterless");
        }
        ...
        public void GetMemberElementName_ParameterMethod_Embedded()
        {
            ...
            var memberName = mi.GetMemberElementName();
            memberName.Should().Be("M:ServiceStack.IntroSpec.Tests.XmlDocumentation.TestClass.EmbeddedClass.Parameters(System.String)");
        }
        //
        ...
        public void GetMemberElementName_ParameterlessMethod_Generic()
        {
            ...
            var memberName = mi.GetMemberElementName();
            memberName.Should().Be("M:ServiceStack.IntroSpec.Tests.XmlDocumentation.TestGenericClass`1.ReturnType");
        }
        ...
        public void GetMemberElementName_ParameterMethod_Generic()
        {
            ...
            var memberName = mi.GetMemberElementName();
            memberName.Should().Be("M:ServiceStack.IntroSpec.Tests.XmlDocumentation.TestGenericClass`1.ParameterOfT(`0)");
        }
        ...
        public void GetMemberElementName_ParameterlessMethod_MultiGeneric()
        {
            ...
            var memberName = mi.GetMemberElementName();
            memberName.Should().Be("M:ServiceStack.IntroSpec.Tests.XmlDocumentation.TestMultiGenericClass`2.NoParam");
        }
        ...
        public void GetMemberElementName_FirstGenericParameterMethod_MultiGeneric()
        {
            ...
            var memberName = mi.GetMemberElementName();
            memberName.Should().Be("M:ServiceStack.IntroSpec.Tests.XmlDocumentation.TestMultiGenericClass`2.First(`0)");
        }
        ...
        public void GetMemberElementName_SecondGenericParameterMethod_MultiGeneric()
        {
            ...
            var memberName = mi.GetMemberElementName();
            memberName.Should().Be("M:ServiceStack.IntroSpec.Tests.XmlDocumentation.TestMultiGenericClass`2.Second(`1)");
        }
        ...
        public void GetMemberElementName_BothGenericParameterMethod_MultiGeneric()
        {
            ...
            var memberName = mi.GetMemberElementName();
            memberName.Should().Be("M:ServiceStack.IntroSpec.Tests.XmlDocumentation.TestMultiGenericClass`2.Both(`0,`1)");
        }
